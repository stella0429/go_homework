...
import (
	...
	"gogin/utils/selector"
	"gogin/utils/selector/wrr"
	"gogin/utils/transport"
	"gogin/utils/transport/grpc/resolver/discovery"

	// init resolver
	_ "gogin/utils/transport/grpc/resolver/direct"
